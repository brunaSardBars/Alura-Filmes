...
{
    public partial class CriandoSessoes : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    LoginProvider = table.Column<string>(type: "varchar(127)", maxLength: 127, nullable: true),
                    ProviderKey = table.Column<string>(type: "varchar(127)", maxLength: 127, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    UserId = table.Column<string>(type: "varchar(127)", maxLength: 127, nullable: true),
                    RoleId = table.Column<string>(type: "varchar(127)", maxLength: 127, nullable: true)
                },
                constraints: table =>
                {
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    UserId = table.Column<string>(type: "varchar(110)", maxLength: 110, nullable: true),
                    LoginProvider = table.Column<string>(type: "varchar(110)", maxLength: 110, nullable: true),
